...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our teshtech Store!</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/images (32).jpeg" alt="mike shirt" style="height:200px;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>mike</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/africaan men.jpeg" alt="african men"style="height:200px;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>african men</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cotton plain.jpeg" alt="cotton plain"style="height:200px;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>cotton plain</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wide rose casual.jpeg" alt="PINK" style="height:200px;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>wide rose casual</h3>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   ...
                   <p>This website is developed by michael +254791833360</p>
               </center>
               </div>
           </footer>
        </div>
